Swal.fire({
    ...
    icon: 'warning',
    confirmButtonText: 'Tengo +18 años o estoy autorizado por un mayor.'
  });
...
const objMalditos = [
    {id: 1, objeto: "Ouija", precio: 7500},
    {id: 2, objeto: "MuñecoVoodoo", precio: 12000},
    {id: 3, objeto: "CartasTarot", precio: 5000}
];

let almacenar = (clave, valor) => {
    localStorage.setItem(clave, valor);
}

for(const objetos of objMalditos){
    almacenar(objetos.id, JSON.stringify(objetos));
}

localStorage.setItem("objMalditos", JSON.stringify(objMalditos));